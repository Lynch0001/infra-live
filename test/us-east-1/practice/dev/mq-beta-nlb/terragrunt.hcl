...
inputs = merge(
  ...
  listeners = {
    ...
    mqb1 = {
      ...
      protocol = "TCP"
      forward  = {
        target_group_key = "mq-dev-b1-target"
      }
    }
    ...
    mqb2 = {
      ...
      protocol = "TCP"
      forward  = {
        target_group_key = "mq-dev-b2-target"
      }
    }
    ...
    mqb3 = {
      ...
      protocol = "TCP"
      forward  = {
        target_group_key = "mq-dev-b3-target"
      }
    }
    ...
    mqb4 = {
      ...
      protocol = "TCP"
      forward  = {
        target_group_key = "mq-dev-b4-target"
      }
    }
    ...
    mqb5 = {
      ...
      protocol = "TCP"
      forward  = {
        target_group_key = "mq-dev-b5-target"
      }
    }
  }
