...
inputs = merge(
  ...
  listeners = {
    ...
    mqg1 = {
      ...
      protocol = "TCP"
      forward  = {
        target_group_key = "mq-dev-g1-target"
      }
    }
    ...
    mqg2 = {
      ...
      protocol = "TCP"
      forward  = {
        target_group_key = "mq-dev-g2-target"
      }
    }
    ...
    mqg3 = {
      ...
      protocol = "TCP"
      forward  = {
        target_group_key = "mq-dev-g3-target"
      }
    }
    ...
    mqg4 = {
      ...
      protocol = "TCP"
      forward  = {
        target_group_key = "mq-dev-g4-target"
      }
    }
    ...
    mqg5 = {
      ...
      protocol = "TCP"
      forward  = {
        target_group_key = "mq-dev-g5-target"
      }
    }
  }
